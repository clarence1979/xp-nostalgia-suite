        ...
        <div className="w-[48%] bg-white">
          ...
          <div className="py-2">
            ...
            >
              ...
              {showPrograms && (
                <div className="absolute left-full top-0 w-[500px] bg-white border-2 border-[hsl(var(--window-border))] shadow-lg max-h-[80vh] overflow-y-auto z-50" style={{ marginTop: '-100px' }}>
                  <div className="py-1">
