  ...
  return (
    <>
      ...
      <div className="fixed bottom-[40px] left-0 w-[400px] bg-white border-2 border-[hsl(var(--window-border))] shadow-lg z-50 flex rounded-tr-lg overflow-hidden">
        ...
        <div className="w-[60%] bg-white">
          ...
          <div className="py-2">
            ...
            >
              ...
              {showPrograms && (
                <div className="absolute left-full top-0 min-w-max bg-white border-2 border-[hsl(var(--window-border))] shadow-lg ml-1">
                  <div className="py-1">
        ...
        <div className="w-[40%] py-2" style={{ background: 'linear-gradient(180deg, hsl(210 89% 62%) 0%, hsl(215 100% 45%) 100%)' }}>
