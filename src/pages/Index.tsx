...
const Index = () => {
  ...
  useEffect(() => {
    const hardcodedIcons: DesktopIconData[] = [
      ...
      { id: '31', name: 'AI Council', icon: '🏛️', description: 'Collaborative AI decision-making and advisory platform', url: 'https://a-icouncil.vercel.app/', icon_type: 'program', position_x: 20, position_y: 520, position_x_mobile: 10, position_y_mobile: 410, category: 'general', open_behavior: 'window', sort_order: 102 },
