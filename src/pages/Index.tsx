...
const Index = () => {
  ...
  useEffect(() => {
    const hardcodedIcons: DesktopIconData[] = [
      ...
      { id: '26', name: 'Code Craft', icon: '⚙️', description: 'Interactive coding platform for learning programming concepts', url: 'https://codecraft.teachingtools.dev', icon_type: 'program', position_x: 440, position_y: 120, position_x_mobile: 350, position_y_mobile: 90, category: 'secondary', open_behavior: 'window', sort_order: 310 },
    ];
