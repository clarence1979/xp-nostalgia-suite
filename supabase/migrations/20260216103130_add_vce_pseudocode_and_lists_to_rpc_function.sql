/*
  # Add VCE Pseudocode and VCE Lists Mastery to RPC Functions
  
  1. Changes
    - Update get_user_program_permissions to include VCE Pseudocode and VCE Lists Mastery
    - Update get_accessible_programs_for_user to include VCE Pseudocode and VCE Lists Mastery
  
  2. Notes
    - These programs were hardcoded in the folder contents but missing from the RPC functions
    - This ensures they appear in the VCE Software Development folder
*/
